      ...
      <div className="bg-[#0F1115] min-h-screen py-10">
        <main className="mx-auto max-w-5xl p-10 md:p-0">
          ...
          <div className="flex justify-end">
            <Link
              className="font-bold text-right text-[#b90343] text-2xl"
              to={`/${data.handle}`}
              target="_blank"
          ...
          <div className="flex flex-col md:flex-row gap-10 mt-10">
            ...
            <div className="w-full md:w-96 bg-[#18181B] px-5 py-10 space-y-6">
              <p className="text-3xl text-center text-[#b90343]">
                {data.handle}
              </p>
              {data.image && (
                <img
              ...
              {data.description && (
                <p className="text-center text-lg font-black text-[#b90343]">
                  {data.description}
                </p>
              )}
